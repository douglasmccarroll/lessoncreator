...
public class Fix_Line_HeaderEng_NativeLanguage_LinePrefix extends Fix_Line {
        ...
        public override function get humanReadableFixDescription():String {
            return "Based on its position as the 7th line in the script, this line should be the " + Constants_LineType.LINE_TYPE_DESCRIPTION__HEADER__NATIVE_LANGUAGE + ", but this doesn't seem to be the case.";
        }
