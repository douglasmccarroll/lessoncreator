package com.brightworks.lessoncreator.fixes {
    ...
    public class Fix_Line_ChunkCmnPhonetic_ContainsRestrictedContent extends Fix_Line {
        ...
        public function Fix_Line_ChunkCmnPhonetic_ContainsRestrictedContent(scriptAnalyzer:Analyzer_Script, lineTypeAnalyzer:Analyzer_ScriptLine, contentRestriction:ContentRestriction) {
